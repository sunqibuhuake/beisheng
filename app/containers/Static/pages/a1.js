    ...
    <div className="frame-containter">
      <div className="footer w100pct color-gray">
        <div className="con">
          <div className="block">
            <ul className="title">
              <li className="cursor down">用户指南</li>
            </ul>
            <ul className="text">
          ...
          <div className="block">
            <ul className="title">
              <li className="cursor down">付款方式</li>
            </ul>
            <ul className="text">
          ...
          <div className="block">
            <ul className="title">
              <li className="cursor down">配送方式</li>
            </ul>
            <ul className="text">
          ...
          <div className="block">
            <ul className="title">
              <li className="cursor down">售后服务</li>
            </ul>
            <ul className="text">
              <li className="tips">Employee Choice商城为您提供两种配送方式，分别是送货上门与店面自提，与顺丰速递合作，保证您购入的产品能够按时送到您的手中。您也可以选择距您最近的店面进行商品提取。</li>
              ...
              <li className="txt">点击<span className="lanse underline"><a href="JavaScript:void(0);">这里</a></span>查看。</li>
            </ul>
          </div>
          <div className="block">
            <ul className="title">
              <li className="cursor down">关于 Employee Choice</li>
            </ul>
            <ul className="text">
